      ...
      <div className="flex items-center space-x-5">
        <Link href="/">
          <img
            ...
            src="https://see.fontimg.com/api/renderfont4/3z8d8/eyJyIjoiZnMiLCJoIjo2NiwidyI6MTAyMCwiZnMiOjY1LCJmZ2MiOiIjMDAwMDAwIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/Uml0ZVVwcw/rooster-personal-use.png"
            alt="logo"
          />
        </Link>
